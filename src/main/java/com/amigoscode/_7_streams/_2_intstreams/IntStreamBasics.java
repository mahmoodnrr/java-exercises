...
public class IntStreamBasics {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        OptionalDouble opt =  IntStream.of(85, 90, 78, 92, 88).average();
        ...
        System.out.println();
        System.out.println(IntStream.of(15, 3, 42, 7, 28).min().getAsInt());
        System.out.println(IntStream.of(15, 3, 42, 7, 28).max().getAsInt());
