...
public class LazyStreams {
    ...
    public static void main(String[] args) {
        ...
        numbers.stream().filter(n -> n > 4).map(n -> n + 1).peek(s -> System.out.println("This should NOT print"));
        numbers.stream().filter(n -> n > 4).map(n -> n + 1).peek(s -> System.out.println("This should print")).forEach(System.out::println);
    }
}
