...
public class DistinctExercise {
    ...
    public static void main(String[] args) {
        ...
        List<Person> people = List.of(new Person("Alice", 30), new Person("Bob", 25), new Person("Alice", 30), new Person("Charlie", 35), new Person("Bob", 25));
        ...
        //           Print the result
        TreeSet<String> collect1 = fruits.stream()
